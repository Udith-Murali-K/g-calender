...
(function () {
    var f = window, h = document, m = f.location, n = function () {
    }, u = /\[native code\]/, w = function (a, b, c) {
        return a[b] = a[b] || c
    }, A = function (a) {
        ...
        var a;
        if ((a = Object.create) && u.test(a))a = a(null); else {
            a = {};
    ...
    var ba = /^(\/[a-zA-Z0-9_\-]+)+$/, ca = /^[a-zA-Z0-9\-_\.,!]+$/, da = /^gapi\.loaded_[0-9]+$/, ea = /^[a-zA-Z0-9,._-]+$/, ia = function (a, b, c, d) {
            var e = a.split(";"), g = e.shift(), l = O[g], k = null;
            ...
            for (var d = 0, e = b.length; d < e; ++d) {
                var g =
                    b[d].split("="), l = decodeURIComponent(g[0]), k = decodeURIComponent(g[1]);
    ...
    var U = decodeURI("%73cript"), V = function (a, b) {
        ...
        na(a, c);
        var d = a ? a.split(":") : [], e = c.h || la(), g = w(E, "ah", C());
        if (g["::"] && d.length) {
            for (var l = [], k = null; k = d.shift();) {
                var q = k.split("."), q = g[k] || g[q[1] && "ns:" + q[0] || ""] || e, x = l.length && l[l.length - 1] || null, y = x;
        ...
        var k = w(H(c), "r", []).sort(), z = w(H(c), "L", []).sort(), v = [].concat(k), T = function (a, b) {
            if (y)return 0;
            f.clearTimeout(x);
            z.push.apply(z, p);
            var d =
        ...
        var p = V(a, z);
        if (p.length) {
            var p = V(a, k), r = w(E, "CP", []), t = r.length;
            r[t] = function (a) {
                if (!a)return 0;
                N("ml1", p, v);
                var b = function (b) {
...
gapi.load("client", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.eiuj32RaZBI.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCM0LxvmvuuJi8lP46OLFJW7dZuk7Q",
